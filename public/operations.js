(function () {
  ...
  bind('#pulseRun', () => send('run awareness pulse'));
  bind('#evaluationRun', () => send('agent evaluation'));
  ...
  bind('#councilRun', () => { const task = value('#specialistTask', 'a task for the specialist council'); if (task) { status('Convening architect, builder, reviewer, and verifier...'); send(`council: ${task}`); } });
